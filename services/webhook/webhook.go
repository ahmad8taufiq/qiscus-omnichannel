...
import (
	...
	response "qiscus-omnichannel/tools/response"

	"github.com/sirupsen/logrus"
)

func WebhookHandler(log *logrus.Logger) http.HandlerFunc {
	...
	if err := json.Unmarshal(body, &data); err != nil {
		...
		log.WithError(err).Error("Failed to unmarshal JSON into Message struct")
		return
	}
